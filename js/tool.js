define(['jquery'],function($){
  ...
  Tool.prototype = {
    ...
    {
      //运动目标值
      var target = obj.target, //滚动条滚动目标值
          time = obj.time ? obj.time : 20,//动画执行速度 默认20毫秒
          step = obj.step ? obj.step : 400,//滚动步长 默认400px
          type = obj.type ? obj.type : 'normal';//动画的速度，fast/normal/slow,默认是normal
      var now_scrollTop = '';
      var over = true;
      //获取运动最终速度值
      switch( type )
